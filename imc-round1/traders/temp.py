...
class Trader:
    ...
    def pepper_signal(self, state: TradingState, order_depth: OrderDepth):
        ...
        target = self.clamp(time_bias + int(round(6 * edge)), -20, 75)
    ...
    def take_orders(
        ...
        # Keep a live working position so buys affect later sell decisions
        # and sells affect later buy decisions within the same timestep.
        ...
        # Take attractive bids using the updated temp_position
